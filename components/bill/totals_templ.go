...
func totalsPayableRows(inv *bill.Invoice, totals *bill.Totals) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "<tr class=\"payable strong\"><th>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for _, er := range totalExchangeRates(inv) {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "<tr class=\"exchange-rate\"><th>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if totals.Advances != nil {
			for _, adv := range inv.Payment.Advances {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "<tr class=\"advance\"><th>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			if len(inv.Payment.Advances) > 1 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "<tr class=\"advance-sum\"><th>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 41, " <tr class=\"due strong\"><th>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
